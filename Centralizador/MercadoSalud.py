    ...
    def monitor_loop(self):
        ...
        while self.running:
            ...
            try:
                ...
                resp = requests.get("https://www.cuidadodesalud.gov/", 
                                    timeout=8, 
                                    impersonate=browser, 
...
# Configuración de MercadoSalud
MERCADOSALUD_URL = "https://www.cuidadodesalud.gov/es/"

MERCADOSALUD_PROXY1 = "http://187.124.149.245:3128"
MERCADOSALUD_PROXY2 = "http://10.0.0.200:5000"